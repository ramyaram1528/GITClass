...
public class AdactTestng {
	@Parameters({"UserName","PassWord","InDate","OutDate","FirstName","LastName","Address","CCNo","CVVNum"})
	@Test
	public void login(String s1,String s2,String d1,String d2,String b1,String b2,String b3,String b4,String b5) throws InterruptedException {
      ...
      //js.executeScript("arguments[0].scrollIntoView(true)", scrollOrder);
